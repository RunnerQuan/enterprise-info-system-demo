...
const form = ref<{
  ...
  edEntryDate: formatDateForInput(props.employeeDepartment?.edEntryDate) ?? getCurrentDate(),
  edLeaveDate: formatDateForInput(props.employeeDepartment?.edLeaveDate) ?? '',
...
const handleSubmit = () => {
  const employeeDepartmentData = {
    ...
    edEntryDate: formatDate(form.value.edEntryDate),
    edLeaveDate: form.value.edLeaveDate ? formatDate(form.value.edLeaveDate) : null
  } as const
