...
<template>
  <div class="space-y-4">
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
      <ul v-if="employeeDepartmentStore.employeeDepartments.length" class="divide-y divide-gray-200">
        <li v-for="employee in employeeDepartmentStore.employeeDepartments" 
            :key="employee.empNo" 
