...
<template>
  <div class="space-y-6">
          ...
          <div class="flex items-center justify-center h-full">
            <div class="space-y-4">
              <div v-for="dept in departmentDistribution" :key="dept.name" class="flex items-center">
                ...
                <div class="w-16 text-right text-sm text-gray-600">{{ dept.value }}人</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div
        @click="navigateTo('/employee-department')"
        class="bg-white rounded-lg shadow p-6 cursor-pointer hover:shadow-lg transition-shadow duration-300"
      >
        <div class="flex items-center space-x-4">
