...
const stats = computed(() => {
  ...
  // 计算在职员工数（有部门关系且在职的员工数量，去重）
  const activeEmployees = new Set(
    employeeDepartmentStore.groupedEmployeeDepartments
      .filter(emp => emp.departments.some(dept => dept.edStatus === 1))
      .map(emp => emp.empNo)
  )
  
  // 计算性别分布
  employeeStore.employees?.forEach(emp => {
    if (emp.gender === 1) maleCount++
    else femaleCount++
  })
  ...
  return {
    ...
    activeEmployeeDepartments: activeEmployees.size, // 使用 Set 的大小作为在职员工数
    maleCount,
    femaleCount
  }
})
...
const genderDistribution = computed(() => [
  { name: '男', value: stats.value.maleCount },
  { name: '女', value: stats.value.femaleCount }
])
          ...
          <div class="flex items-center space-x-8">
            <div class="text-center">
              <div class="relative w-32 h-32">
                ...
                <div class="absolute inset-0 flex items-center justify-center">
                  <div class="text-center">
                    <div class="text-xl font-bold text-blue-500">{{ stats.maleCount }}</div>
            ...
            <div class="text-center">
              <div class="relative w-32 h-32">
                ...
                <div class="absolute inset-0 flex items-center justify-center">
                  <div class="text-center">
                    <div class="text-xl font-bold text-pink-500">{{ stats.femaleCount }}</div>
